      ...
      <div className={`wrapper-modal-video`}>
        <div className="modal-video">
          <div className="wrapper-close">
            ...
            >
              <img src={close_icon} style={{ width: "30px" }} alt="DashBoard" />
            </button>
          </div>
          <video
          ...
          />
          <div
            className="wrapper-video-details text-light"
            title={video.description}
          >
            <strong>{video.title}</strong> -{" "}
            {cutLegend(video.description, 20, false)}
          </div>
        </div>
      </div>
    )
