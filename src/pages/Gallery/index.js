  ...
  return(
    ...
    <div className="container-fluid">
      <div className="container-fluid d-flex align-items-baseline w-100">
        <div className="d-flex align-items-end pl-2 pt-5"> <img src={gallery_icon} style={{ width: "45px" }} alt="DashBoard" /> 
        <h3 className="mt-4 ml-3 mb-0 display-3 title align-text-bottom">Galeria de Fotos</h3></div>
      </div>
      <hr className="my"></hr>
      <div className="container-fluid" >
