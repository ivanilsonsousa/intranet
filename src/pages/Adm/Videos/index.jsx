...
function Videos() {
  ...
  return (
    <>
      ...
      >
        <div className="form-row">
          ...
          <div className="col">
            ...
            >
              <option value="Sem Empresa" hidden>
        ...
        <div className="form mt-1">
          ...
          <label className="file-upload">
            ...
            <span
              className={`file-upload__label ${fileThumb?.name && "select"}`}
            >
              {fileThumb?.name
                ? cutLegend(fileThumb.name)
        ...
        <div className="form mt-1">
          ...
          <label className="file-upload">
            ...
            <span
              className={`file-upload__label ${fileVideo?.name && "select"}`}
            >
              {fileVideo?.name
                ? cutLegend(fileVideo.name)
                : "Selecione um arquivo..."}
            </span>
          </label>
        </div>
        ...
        {!!progress && (
          <Line percent={progress} strokeWidth="1" strokeColor="#a52a2a" />
        )}
      </Modal>
        ...
        <div className="form-row">
          <div className="col">
            ...
            <input
              ...
              onChange={(e) =>
                setVideoEdit({ ...videoEdit, title: e.target.value })
              }
            />
          </div>
          <div className="col">
            ...
            <select
              ...
              id="menu-select"
              onChange={(e) =>
                setVideoEdit({ ...videoEdit, company: e.target.value })
              }
          ...
          <label className="file-upload">
            ...
            <span
              className={`file-upload__label ${
                fileThumbEdit?.name && "select"
              }`}
            >
              {fileThumbEdit?.name
                ? cutLegend(fileThumbEdit.name)
                : "Selecione um arquivo..."}
            </span>
          </label>
        </div>
        <div className="form-row">
          <div className="col">
            ...
            <textarea
              ...
              onChange={(e) =>
                setVideoEdit({ ...videoEdit, description: e.target.value })
              }
            ></textarea>
          </div>
        </div>
        {!!progress && fileThumbEdit && (
          <Line percent={progress} strokeWidth="1" strokeColor="#a52a2a" />
        )}
      </Modal>
      ...
      <ModalVideo ref={modalVideo} video={videoEdit} />
    </>
  );
}
